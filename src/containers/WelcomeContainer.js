...
const WelcomeContainer = () =>{
    const location = useLocation();//Nos trae el state
    ...
    useEffect(//efecto que se hace antes de hacer un render
        () =>{
    ...
    const goBack = () => history.goBack();//Regresa a la vista anterior
